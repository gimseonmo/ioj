<template>
    <div class="fixed w-full h-full top-0 left-0 flex items-center justify-center z-50 overflow-y-auto p-4" v-if="open">
        <div class="absolute w-full h-full bg-black bg-opacity-50" @click="close"></div>
        <div class="relative max-h-full w-full" :class=setWidth>
        <div class="container py-5 px-4 bg-white overflow-visible md:rounded-lg shadow">
